  ...
  'syms': { 'domolibrary.classes.DomoAccount': { 'domolibrary.classes.DomoAccount.AccountConfig': ( 'classes/domoaccount.html#accountconfig',
            ...
            'domolibrary.integrations.DomoJupyter': { 'domolibrary.integrations.DomoJupyter.DomoJupyterAccount_InstanceAuth': ( 'integrations/domojupyter.html#domojupyteraccount_instanceauth',
                                                      ...
                                                      'domolibrary.integrations.DomoJupyter.get_jupyter_account': ( 'integrations/domojupyter.html#get_jupyter_account',
                                                                                                                    'domolibrary/integrations/DomoJupyter.py')},
            'domolibrary.pdp_routes': { 'domolibrary.pdp_routes.create_policy': ( 'routes/routes.pdp_routes.html#create_policy',
                                                                                  'domolibrary/pdp_routes.py'),
                                        'domolibrary.pdp_routes.generate_policy_body': ( 'routes/routes.pdp_routes.html#generate_policy_body',
                                                                                         'domolibrary/pdp_routes.py'),
                                        'domolibrary.pdp_routes.generate_policy_parameter_simple': ( 'routes/routes.pdp_routes.html#generate_policy_parameter_simple',
                                                                                                     'domolibrary/pdp_routes.py'),
                                        'domolibrary.pdp_routes.get_pdp_policies': ( 'routes/routes.pdp_routes.html#get_pdp_policies',
                                                                                     'domolibrary/pdp_routes.py'),
                                        'domolibrary.pdp_routes.update_policy': ( 'routes/routes.pdp_routes.html#update_policy',
                                                                                  'domolibrary/pdp_routes.py')},
