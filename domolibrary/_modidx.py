  ...
  'syms': { 'domolibrary.classes.DomoAccount': { 'domolibrary.classes.DomoAccount.Account_Accesslist': ( 'classes/domoaccount.html#account_accesslist',
            ...
            'domolibrary.classes.DomoInstanceConfig': { 'domolibrary.classes.DomoInstanceConfig.DomoInstanceConfig': ( 'classes/domoinstanceconfig.html#domoinstanceconfig',
                                                        ...
                                                        'domolibrary.classes.DomoInstanceConfig.DomoInstanceConfig.toggle_is_user_invite_enabled': ( 'classes/domoinstanceconfig.html#domoinstanceconfig.toggle_is_user_invite_enabled',
                                                                                                                                                     'domolibrary/classes/DomoInstanceConfig.py'),
                                                        'domolibrary.classes.DomoInstanceConfig.DomoInstanceConfig.toggle_sandbox_is_same_instance_promotion_enabled': ( 'classes/domoinstanceconfig.html#domoinstanceconfig.toggle_sandbox_is_same_instance_promotion_enabled',
                                                                                                                                                                         'domolibrary/classes/DomoInstanceConfig.py'),
