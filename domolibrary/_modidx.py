  ...
  'syms': { 'domolibrary.classes.DomoAccount': { 'domolibrary.classes.DomoAccount.AccountConfig': ( 'classes/domoaccount.html#accountconfig',
            ...
            'domolibrary.routes.bootstrap': { 'domolibrary.routes.bootstrap.GetBootstrap_InvalidAuthMethod': ( 'routes/bootstrap.html#getbootstrap_invalidauthmethod',
                                              ...
                                              'domolibrary.routes.bootstrap.get_bootstrap_pages': ( 'routes/bootstrap.html#get_bootstrap_pages',
                                                                                                    'domolibrary/routes/bootstrap.py')},
            'domolibrary.routes.datacenter': { 'domolibrary.routes.datacenter.generate_search_datacenter_account_body': ( 'routes/datacenter_routes.html#generate_search_datacenter_account_body',
